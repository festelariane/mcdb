...
namespace Mercedes.Core.Plugins
{
    public class PluginDescriptor : IComparable<PluginDescriptor>
    {
        ...
        {
            object instance;
            if(!SiteEngine.Instance.ContainerManager.TryResolve(PluginType,null,out instance))
            {
                instance = SiteEngine.Instance.ContainerManager.ResolveUnregistered(PluginType);
            }
